...
class TestCalculator(unittest.TestCase):
    def test_add(self):
        """
            ...
            # p N
            # N N
        Happy path testing --> getting the actual value (LHS)
        to be the same as the expected (RHS)
        """
    ...
    def test_div(self):
        ...
        self.assertEqual(Calculator.div(-10, -10), 1)
        # Sad path testing: PASS: if the developer has
        # raised the expected exception in certain situation
        #
